    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            ...
                            <div class="user-info">
                                <div><strong>Energy <strong>Monitoring Dashboard</strong></div>
                                <div class="user-text-online">
                                    <span class="user-circle-online btn btn-success btn-circle "></span>&nbsp;Active
                                </div>
                            </div>
                        </div>
        ...
        <div id="page-wrapper">
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Energy Data Monitoring</h1>
                </div>
                <!--end  page header -->
            </div>
            <div class="row">
            ...
            <!-- End Bar Chart -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Energy Cost against production
                        </div>
                        <div class="panel-body">
